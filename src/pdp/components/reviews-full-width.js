...
export const Reviews = (props) => {
  ...
  return (
    <div className="product-ribbon-container">
      <hr className="section" style={{ ...props.hr, ...divider }} />
      <div className="section" style={feefoTitleSection}>
        <h2 style={{ ...props.MediumFont, ...reviewTitle }}>Reviews</h2>
        {props.feefoBrandLogo}
      </div>
      <div style={reviewOverview}>
        <div className="section" style={displayFlex}>
      ...
      <div className="section" style={individualReviewContainer}>
